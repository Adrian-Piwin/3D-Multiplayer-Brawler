...
public class ProjectileMoveScript : MonoBehaviour {
	...
	private float range;
	private Collider colliderIgnore;

	void CreateBullet () {
        startPos = transform.position;
        rb = GetComponent <Rigidbody> ();

		Physics.IgnoreCollision(gameObject.GetComponent<Collider>(), colliderIgnore);
	...
	public void setupBullet(bool bnc, float bncForce, float spd, float acr, float dmg, float impForce, float rng, Collider ignoreCol){
		bounce = bnc;
